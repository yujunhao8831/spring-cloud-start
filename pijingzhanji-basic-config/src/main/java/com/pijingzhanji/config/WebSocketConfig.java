...
@Getter
@Setter
@ConfigurationProperties( prefix = "pijingzhanji.web-socket" )
@ConditionalOnExpression( "${pijingzhanji.web-socket.enabled:false}" )
public class WebSocketConfig extends AbstractWebSocketMessageBrokerConfigurer {
    ...
    private String[] stompEndpointsPaths                  = { "/pijingzhanji" }; // default
    /**
     * WebSocket拦截器
     */
     ...
     *    var serverEndpoint = "/pijingzhanji"; // 服务端配置的端点
     *
     *    // 连接
     *    function connect() {
    ...
    public void registerStompEndpoints ( StompEndpointRegistry registry ) {
        ...
        // 表示添加了一个 /pijingzhanji 端点,客户端就可以通过这个端点来进行连接.
        // pijingzhanji
