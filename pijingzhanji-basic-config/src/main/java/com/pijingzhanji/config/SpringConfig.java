...
import com.pijingzhanji.common.converter.StringToDateConverter;
import com.pijingzhanji.common.filter.RequestLoggingFilter;
import com.pijingzhanji.common.interceptor.InjectionAttackInterceptor;
...
public class SpringConfig extends WebMvcConfigurerAdapter implements ErrorPageRegistrar {
    ...
    @ConditionalOnProperty( prefix = "pijingzhanji.filter.injection-attack-interceptor", name = "enabled", havingValue = "true" )
